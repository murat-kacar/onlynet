        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntendedOwnerEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    DatabaseName = table.Column<string>(type: "character varying(63)", maxLength: 63, nullable: true),
                    DatabaseUser = table.Column<string>(type: "character varying(63)", maxLength: 63, nullable: true),
                    DatabasePassword = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_platform_audit_log_Action",
                table: "platform_audit_log",
                column: "Action");

            migrationBuilder.CreateIndex(
                name: "IX_platform_audit_log_CreatedAt",
                table: "platform_audit_log",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_provisioning_job_steps_JobId",
