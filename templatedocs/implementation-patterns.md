...
public class TenantsController : ControllerBase
{
    ...
    {
        _context = CenterContext = context;
    }
...
{
  "ConnectionStrings": {
    "TenantDb": "Host=localhost;Database=tabflow_tenant;Username=tabflow_tenant_app;Password=changeme_tenant"
  }
}
```
...
```bash
# Platform migrations
dotnet ef migrations add MigrationName --context PlatformDbContext --output-dir Migrations/Platform --project src/infra/postgres/TabFlow.Migrations.csproj

# Tenant migrations
dotnet ef migrations add MigrationName --context TenantDbContext --output-dir Migrations/Tenant --project src/infra/postgres/TabFlow.Migrations.csproj
```

### Applying Migrations

```bash
dotnet ef database update --context PlatformDbContext --project src/infra/postgres/TabFlow.Migrations.csproj
dotnet ef database update --context TenantDbContext --project src/infra/postgres/TabFlow.Migrations.csproj
```
