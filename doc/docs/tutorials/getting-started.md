...
## 1. The Constitution And Documentation Charter

How TabFlow contributors decide, ship, document, review, operate, and
measure. Read these first — they govern everything that follows.
...
## 3. Runtime Surfaces And Render Modes
...
## 5. Tenant Lifecycle And Provisioning
...
## 6. Authentication, Roles, And The Customer Session
